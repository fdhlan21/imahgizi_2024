...
export default function FromIbuHamilAnemia({ navigation }) {
  ...
  const HandleSimpan = () => {
    if ((form.namaibu.length == 0) || (form.anakke.length == 0) || (form.nik.length == 0) || (form.usiaibu.length == 0) || (form.alamat.length == 0) || (form.usiakehamilan.length == 0) || (form.hasilpengukuranhb.length == 0)) {
          ...
          <View style={{ padding: 10 }}>
            <View style={{ marginTop: '10%' }}>
              ...
              <TextInput style={{
                backgroundColor: '#f5f5f5', borderRadius: 5, borderWidth: 1, height: 40, fontFamily: 'Poppins-Regular', fontSize: 12, color: 'black',
                paddingRight: 10, paddingLeft: 10,
              }} placeholder='Anak Ke-' placeholderTextColor='gray' keyboardType='numeric' value={form.anakke}
              ...
              <TextInput style={{
                backgroundColor: '#f5f5f5', borderRadius: 5, borderWidth: 1, height: 40, fontFamily: 'Poppins-Regular', fontSize: 12, color: 'black',
                paddingRight: 10, paddingLeft: 10,
              }} placeholder='Alamat' placeholderTextColor='gray' value={form.alamat}
