          ...
          <View style={{ padding: 10, }}>
            ...
            <View style={{ marginTop: '10%' }}>
              ...
              <View style={{ marginTop: 20 }}>
                ...
                <TextInput style={{
                  backgroundColor: '#f5f5f5', borderWidth: 1, borderRadius: 5, height: 40, paddingRight: 10,
                  paddingLeft: 10, color: 'black', fontFamily: "Poppins-Regular", fontSize: 12
                }} placeholder='Materi Konseling' placeholderTextColor='gray'
              ...
              <View style={{ marginTop: 20 }}>
                ...
                <TextInput style={{
                  backgroundColor: '#f5f5f5', borderWidth: 1, borderRadius: 5, height: 40, paddingRight: 10,
                  paddingLeft: 10, color: 'black', fontFamily: "Poppins-Regular", fontSize: 12
                }} placeholder='Pendata' placeholderTextColor='gray'
